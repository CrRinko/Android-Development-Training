package cn.aurora_x.android.sharedpreferences;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onSaveButtonClicked(View view) {
        editor.putString(Key_name,"Rinko");
        editor.putString(Key_id,"2014011374");
        editor.apply();
    ...
    public void onLoadButtonClicked(View view) {
        ...
        Toast.makeText(this,"Load: "+name+" "+id,Toast.LENGTH_SHORT).show();
    }
}
