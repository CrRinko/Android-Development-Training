...
import cn.aurora_x.android.fragment_v2.WordFragment.OnListFragmentInteractionListener;
import cn.aurora_x.android.fragment_v2.wordList.WordContent.WordItem;
...
public class MyWordRecyclerViewAdapter extends RecyclerView.Adapter<MyWordRecyclerViewAdapter.ViewHolder> {
    ...
    public MyWordRecyclerViewAdapter(List<WordItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
